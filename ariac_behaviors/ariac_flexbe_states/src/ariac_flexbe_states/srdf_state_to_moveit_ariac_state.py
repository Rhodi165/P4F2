	...
	#> joint_values		float[]		    Target configuration of the joints.
        ...
        def __init__(self):
                ...
                super(SrdfStateToMoveitAriac, self).__init__(outcomes=['reached', 'planning_failed', 'control_failed', 'param_error'],
							input_keys = ['config_name', 'move_group', 'move_group_prefix', 'action_topic', 'robot_name'],
        ...
        def on_enter(self, userdata):
                ...
                if rospy.has_param(userdata.move_group_prefix + '/robot_description_semantic'):
                        self._srdf_param = rospy.get_param(userdata.move_group_prefix + '/robot_description_semantic')
                else:
