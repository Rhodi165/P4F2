...
class SrdfStateToMoveit(EventState):
 	...
 	># joint_values         float[]             Target configuration of the joints.
        ...
        def __init__(self, config_name, move_group = "", move_group_prefix = "", action_topic = '/move_group', robot_name=""):
                '''
                Constructor
                '''
                ...
                if rospy.has_param(move_group_prefix + '/robot_description_semantic'):
                        self._srdf_param = rospy.get_param(move_group_prefix + '/robot_description_semantic')
                else:
